...
import PersonContactAPI from "../../../../api/person/contact/PersonContactAPI"
...
export const actions = {
    ...
    async edit({ commit }, id) {
        ...
        await PersonContactAPI.edit(id)
    ...
    listByIdPerson({ commit }, idPerson) {
        commit("fetching", true)
        PersonContactAPI.listByIdPerson(idPerson)
